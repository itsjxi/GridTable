 ...
 export class TableView{
    ...
    tableHeadRender(coulms){
        ...
        const tableheadData = coulms.map((item , index) => `<th>${item.title}</th>`).join("");
    ...
    tableDataRender(tableBody,gridData,start_index){
        gridData.forEach((item,index) => {
            ...
            <button class="edit-button"><i class="fa fa-pencil" style="font-size: 20px; color: blue;"></i></button>
            <button class="save-button" style = "display: none"><i class="fa fa-check" style="font-size: 20px; color: blue;"></i></button>                       
                                   </td>
                                   <td>
...
handleSort(sortOrder,sortedColumnIndex ,columnIndex,tableBody) {
    ...
    console.log(sortedColumnIndex, columnIndex);
...
//implimenting edit functionality.....
editModeOn(row){
...
eventOnSaveChanges(tableBody,gridData){
    ...
    saveButtons.forEach((saveButton) => {
        saveButton.addEventListener('click', (event) => {
            ...
            console.log(this.gridData,"---------")
            tableBody.innerHTML= "";
            // this.tableDataRender(tableBody,gridData)
            this.displayRecords(this.record_per_page);
            this.generatePage(this.total_page);
  });
});
   ...
   addRow(){
    ...
    newRow.innerHTML += `<td>
    <button class="edit-button" style = "display: none"><i class="fa fa-pencil" style="font-size: 20px; color: blue;"></i></button>
    <button class="save-button" style = "display: block"><i class="fa fa-check" style="font-size: 20px; color: blue;"></i></button>                       
                           </td>
                           <td>
                             <i class="fa fa-trash-o  deleteRow" style="font-size: 20px; color: red;"></i>
                           </td>`;
   ...
   generatePage(total_page) {
    ...
    let prevButton = `<button class="prevButton" >Previous</button>`;
    let nextButton = `<button class="nextButton">Next</button>`;
    let pageValue = '';
